...
ActiveRecord::Schema[7.0].define(version: 2023_09_07_150100) do
  ...
  create_table "statuses", id: :bigint, default: -> { "timestamp_id('statuses'::text)" }, force: :cascade do |t|
    ...
    t.datetime "deleted_at", precision: nil
    t.bigint "quote_id"
    t.datetime "expires_at", precision: nil, default: ::Float::INFINITY, null: false
    t.integer "expires_action", default: 0, null: false
    t.datetime "expired_at", precision: nil
    t.datetime "edited_at", precision: nil
    t.boolean "trendable"
    t.bigint "ordered_media_attachment_ids", array: true
    t.index ["account_id", "id", "visibility", "updated_at"], name: "index_statuses_20210710", order: { id: :desc }, where: "(deleted_at IS NULL)"
    t.index ["account_id"], name: "index_statuses_on_account_id"
    t.index ["deleted_at"], name: "index_statuses_on_deleted_at", where: "(deleted_at IS NOT NULL)"
    t.index ["expired_at"], name: "index_statuses_on_expired_at"
